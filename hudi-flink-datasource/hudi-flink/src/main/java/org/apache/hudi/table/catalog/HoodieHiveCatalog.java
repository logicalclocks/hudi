...
public class HoodieHiveCatalog extends AbstractCatalog {
  ...
  private Table instantiateHiveTable(ObjectPath tablePath, CatalogBaseTable table, String location, boolean useRealTimeInputFormat) throws IOException {
    ...
    if (hiveConf.get(HiveConf.ConfVars.METASTORE_URIS.varname) != null) {
      properties.put(HadoopConfigurations.HADOOP_PREFIX + HiveConf.ConfVars.METASTORE_URIS.varname, hiveConf.get(HiveConf.ConfVars.METASTORE_URIS.varname));
    }
